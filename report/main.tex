...
Together with the 25~ms sensor acquisition interval at 40~Hz, the resulting 55~ms total response delay causes the vehicle to travel up to half a meter before updated control commands take effect.
...
Across extensive evaluations, the resulting policy demonstrates effective and robust racing performance.
